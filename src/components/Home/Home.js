        ...
        <div className="flashSale-section">
          ...
          <div className="card">
            <div className=" position-relative card-img-container">
              <img className="card-img-top" src="{{asset('images/'.$product->image)}}" alt="Card image cap" />
            </div>
            <div className="card-body ">
              ...
              <button data-link="{{$product->link}}" className="btn btn-container BuyNow btn-light d-flex">
                <img className="cart-img" src="" />
